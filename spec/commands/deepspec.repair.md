---
description: Repair DeepSpec tracking after file renames or moves. Realigns tracking.json with current task paths from APPROACH.md artifacts. Maintenance only — never edits A-B-C prose.
---
